...
public class WaterObjectEntity {
    ...
    private Integer cadastreId;

    @Column(name = "fed_water_object_id")
    private Integer fedWaterObjectId;

    @Column(name = "owner_id")
    private Integer ownerId;

    @Column(name = "executive_authority_type_id")
    private Integer executiveAuthorityTypeId;
    ...
    @Column(name = "confirmation_document_id")
    private Integer confirmationDocumentId;
