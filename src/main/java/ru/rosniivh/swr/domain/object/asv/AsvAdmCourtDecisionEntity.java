...
@Setter
@Entity
@Table(name = "o_asv_adm_court_decision", schema = "dbo")
public class AsvAdmCourtDecisionEntity {
    @Id
    ...
    public final boolean equals(Object o) {
        ...
        AsvAdmCourtDecisionEntity that = (AsvAdmCourtDecisionEntity) o;
