...
@Setter
@Entity
@Table(name = "o_asv_fact_quality", schema = "dbo")
public class AsvFactQualityEntity {
    @Id
    ...
    @Column(name = "lab_cert_num")
    private String labCertNum;

    @Column(name = "lab_cert_period")
    private String labCertPeriod;
    ...
    public final boolean equals(Object o) {
        ...
        AsvFactQualityEntity that = (AsvFactQualityEntity) o;
